...
//  bad_query
//
//  Ported from FilzaSlop (MCMBridge.m). No Filza-specific dependencies.
//
    ...
    uint64_t containerClass, NSUInteger limit, NSString **error)
{
    ...
    // Metadata-only, no-create lookup.
                         ...
                         error:(NSString **)error
{
    ...
    // /var is a symlink to /private/var on iOS — normalize so callers can
    // compare paths against lstat results (which see /private/...).
